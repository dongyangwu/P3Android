...
public class LocationManagerService extends ILocationManager.Stub {
    ...
    // Location resolution level; mocked location data
    private static final int RESOLUTION_LEVEL_MOCKED = 3;
    ...
    private void loadProvidersLocked() {
        ...
        service components implgementing these providers.
    ...
    private int getAllowedResolutionLevel(int pid, int uid) {
        if (mContext.checkPermission(android.Manifest.permission.ACCESS_FINE_LOCATION,
            ...
            Log.v(TAG, "getAllowedResolutionLevel--------------ACCESS_FINE_LOCATION---");
            return RESOLUTION_LEVEL_FINE;
        } else if (mContext.checkPermission(android.Manifest.permission.ACCESS_FINE_LOCATION,
                pid, uid) == PackageManager.PERMISSION_MOCKED) {
            Log.v(TAG, "getAllowedResolutionLevel--------------ACCESS_Mocked_LOCATION---");
            return RESOLUTION_LEVEL_MOCKED;
        } else if (mContext.checkPermission(android.Manifest.permission.ACCESS_COARSE_LOCATION,
                pid, uid) == PackageManager.PERMISSION_GRANTED) {
            Log.v(TAG, "getAllowedResolutionLevel--------------ACCESS_COARSE_LOCATION---");
            ...
            Log.v(TAG, "getAllowedResolutionLevel--------------RESOLUTION_LEVEL_NONE---");
    ...
    private int getMinimumResolutionLevelForProviderUse(String provider) {
        if (LocationManager.GPS_PROVIDER.equals(provider) ||
            ...
            return RESOLUTION_LEVEL_COARSE;
        } else if (LocationManager.MOCKED_PROVIDER.equals(provider)) {
            return RESOLUTION_LEVEL_MOCKED;
        } else {
            // mock providers
    ...
    public static int resolutionLevelToOp(int allowedResolutionLevel) {
        if (allowedResolutionLevel != RESOLUTION_LEVEL_NONE) {
            ...
            } else if (allowedResolutionLevel == RESOLUTION_LEVEL_MOCKED) {
                return AppOpsManager.OP_MOCKED_LOCATION;
            } else {
    ...
    public List<String> getProviders(Criteria criteria, boolean enabledOnly) {
         ...
         * Add by: Dongyang Wu
         */
        if (allowedResolutionLevel == RESOLUTION_LEVEL_MOCKED) {
            out = new ArrayList<String>(mProviders.size());
            out.add(LocationManager.MOCKED_PROVIDER);
            return out;
        }
    ...
    public String getBestProvider(Criteria criteria, boolean enabledOnly) {
        ...
        if (!providers.isEmpty()) {
            ...
            Log.v(TAG, "getBestProvider(" + criteria + ", " + enabledOnly + ")=" + result);
            return result;
        }
    ...
    private String pickBest(List<String> providers) {
        if (providers.contains(LocationManager.MOCKED_PROVIDER)) {
            return LocationManager.MOCKED_PROVIDER;
    ...
    public void requestLocationUpdates(LocationRequest request, ILocationListener listener,
        ...
        /**add by wdy */
        if (allowedResolutionLevel == RESOLUTION_LEVEL_MOCKED) {
            Slog.v(TAG, packageName + "mock location");
            return;
        }
    ...
    public Location getMockLocation(String mockProviderName) {
    ...
    public Location getLastLocation(LocationRequest request, String packageName) {
        ...
        /**add by wdy */
        if (allowedResolutionLevel == RESOLUTION_LEVEL_MOCKED) {
            return getMockLocation(LocationManager.MOCKED_PROVIDER);
        }
