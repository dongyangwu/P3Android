...
public class PhoneInterfaceManager extends ITelephony.Stub {
     ...
     * @return
     */
    private int enforceReadMockPermission() {
        return mApp.enforceCallingOrSelfMockPermission(android.Manifest.permission.READ_PHONE_STATE, null);
    }
    ...
    public String getLine1NumberForDisplay(long subId) {
        ...
        if (enforceReadMockPermission() == PackageManager.PERMISSION_MOCKED) {
            return "15133656692";
        }
